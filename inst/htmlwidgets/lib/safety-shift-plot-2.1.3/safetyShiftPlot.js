(function(global, factory) {
    ...
    function safetyShiftPlot(element, settings) {
        ...
        var controls = webcharts.createControls(
            document.getElementById(element.id).querySelector('#ssp-controls'),
            {
                location: 'top',
        ...
        var chart = webcharts.createChart(
            document.getElementById(element.id).querySelector('#ssp-chart'),
            syncedSettings,
            controls
        );
        ...
        var listing = webcharts.createTable(
            document.getElementById(element.id).querySelector('#ssp-listing'),
              listingSettings
        );
        listing.init([]);
