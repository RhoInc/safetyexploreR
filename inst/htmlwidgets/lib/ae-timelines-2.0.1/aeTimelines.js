var aeTimelines = function (webcharts, d3$1) {
    ...
    function syncSettings(preSettings) {
        ...
        if (nextSettings.highlight) {
            ...
            var highlightCircle = { 'type': 'circle',
    ...
    function addHighlightLegendItem(chart) {
        ...
        var highlightLegendItem = chart.wrap.select('.legend').append('li').attr('class', 'highlight').style({ 'list-style-type': 'none',
            'margin-right': '1em',
            'display': 'inline-block' });
        var highlightLegendColorBlock = highlightLegendItem.append('svg').attr({ width: '1.75em',
